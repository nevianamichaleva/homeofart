export const children = [
  {
    ...
    artworks: [
      ...
      },
      {
        ...
        description: "Нарисувах слънцето, защото ми харесва неговата светлина и енергия. Представих си, че слънцето е огромно кълбо от светлина, който свети и загрява земята. Докато рисувах, си мислех колко е страхотно, че има такова красиво и бляскаво светило в небето.",
        year: 2026,
        code: "boryana-2"
      }
    ]
