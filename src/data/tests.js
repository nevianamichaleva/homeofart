...
const ISTORIYA_TRAKIYA_OBSHTESTVO_QUESTIONS = [
  ...
  { q: "Какво е симпосион според описанията на тракийските пиршества?", correct: "Пиршество с разговори, музика и пиене на вино", wrong1: "Военна тренировка", wrong2: "Селскостопански празник" },
