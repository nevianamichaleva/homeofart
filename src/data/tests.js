...
const BULGARSKI_GRAMATIKA_4_QUESTIONS = [
  ...
  { q: 'В кое изречение НЯМА грешка?', correct: 'В март започва пролетта.', wrong1: 'В неделя заминаваме на Самоков.', wrong2: 'Ема обича разходките в планината.', wrong3: 'Двете момичета живееха у селото.' },
