...
const GEOGRAFIA_MIX_QUESTIONS = [
  ...
  { type: 'text', q: 'Дайте пример за райони в света, които са гъстонаселени.', correct: 'Южна и Източна Азия', acceptedAnswers: ['Южна Азия', 'Източна Азия', 'Южна и Източна Азия'] },
  ...
  { q: 'Коренно население на кой континент са ескимосите и инуитите?', correct: 'Северна Америка', wrong1: 'Африка', wrong2: 'Азия', wrong3: 'Европа' },
  ...
  { q: 'Какво е изобразено на политическата карта?', correct: 'Държавите', wrong1: 'Климатичните пояси', wrong2: 'Релефът', wrong3: 'Природните зони' },
  ...
  { q: 'Коя от организациите България НЕ членува?', correct: 'НАТО', wrong1: 'ООН', wrong2: 'ОПЕК', wrong3: 'ЕС' },
  ...
  { q: 'Изобразената стопанска дейност попада в:', correct: 'Услуги', wrong1: 'Добивни', wrong2: 'Преработващи', wrong3: 'Селско стопанство' },
];
